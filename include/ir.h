...
typedef enum{OP_ADD,OP_SUB,OP_MUL,OP_SDIV,OP_UDIV,OP_SREM,OP_UREM,OP_AND,OP_OR,OP_XOR,OP_SHL,OP_LSHR,OP_ASHR,OP_FADD,OP_FSUB,OP_FMUL,OP_FDIV,OP_FREM,OP_FNEG,OP_NEG,OP_NOT,OP_ICMP,OP_FCMP,OP_LOAD,OP_STORE,OP_MEMCPY,OP_GEP,OP_GEP_FIELD,OP_ALLOCA,OP_CALL,OP_PHI,OP_SELECT,OP_ZEXT,OP_SEXT,OP_TRUNC,OP_BITCAST,OP_PTRTOINT,OP_INTTOPTR,OP_STR,OP_SITOFP,OP_UITOFP,OP_FPTOSI,OP_FPTOUI,OP_FPEXT,OP_FPTRUNC,OP_VA_START,OP_VA_ARG,OP_VA_END,OP_BR,OP_CBR,OP_SWITCH,OP_RET,OP_UNREACHABLE}IROpcode;
...
typedef struct IRFunc{
    ...
    int nvregs;
    int nlocals;
    int vararg;         /* 1 if the function takes ... */
    int va_list_off;    /* rbp-relative positive offset of the va_list struct */
    int vararg_save_off;/* rbp-relative positive offset of the register save area */
} IRFunc;
