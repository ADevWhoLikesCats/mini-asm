...
typedef struct IRType{IRTypeKind kind;}IRType;
...
typedef enum{OP_ADD,OP_SUB,OP_MUL,OP_SDIV,OP_UDIV,OP_SREM,OP_UREM,OP_AND,OP_OR,OP_XOR,OP_SHL,OP_LSHR,OP_ASHR,OP_FADD,OP_FSUB,OP_FMUL,OP_FDIV,OP_FREM,OP_FNEG,OP_NEG,OP_NOT,OP_ICMP,OP_FCMP,OP_LOAD,OP_STORE,OP_GEP,OP_ALLOCA,OP_CALL,OP_PHI,OP_SELECT,OP_ZEXT,OP_SEXT,OP_TRUNC,OP_BITCAST,OP_PTRTOINT,OP_INTTOPTR,OP_BR,OP_CBR,OP_SWITCH,OP_RET,OP_UNREACHABLE}IROpcode;

typedef enum{ARG_NONE,ARG_VREG,ARG_IMM,ARG_LABEL}IRArgKind;
